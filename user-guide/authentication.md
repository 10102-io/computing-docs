...
- **Sepolia** testnet is available for kicking the tires without real funds. It's useful for trying a flow end-to-end (creation, activation, claim) with throwaway ETH.

Switch networks in your wallet; the app follows. There is full feature parity between mainnet and Sepolia: everything you can do on one, you can do on the other.
