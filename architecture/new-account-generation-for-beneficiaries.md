...
Many intended beneficiaries may not have an Ethereum accounts, or know how to get one. To strike a balance between security and user-friendliness, the following optional feature generate a new account with its private key stored in a QR code that can be given to the designated beneficiary.
